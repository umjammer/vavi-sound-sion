...
public class MapperNSF extends Mapper {
    ...
    public static final int $WAIT = 0x4700;
    public static final int $INIT = 0x4704;
    public static final int $PLAY = 0x470a;
    // nse asm code          $4700    01    02    03   /04    05    06    07    08    09   /0a    0b    0c    0d    0e    0f
    private static final int[] code = {
            0x01, 0x02, 0x4c, 0x00, 0x47, 0x00, 0x20, 0xff, 0xff, 0x4c, 0x00, 0x47, 0x8d, 0x1e, 0x40, 0x20, 0xff, 0xff,
            0x8d, 0x1f, 0x40, 0x4c, 0x00, 0x47
    };

    @Override
    public int ExRead(int addr) {
        return (addr >= 0x4700 && addr < 0x4716) ? code[addr - 0x4700] : 0;
    }
    ...
    public void overwriteCodeData(NSFData data) {
