...
public class SiMMLSimulatorDCSG extends SiMMLSimulatorBase {
    ...
    public SiMMLSimulatorDCSG() {
        super(MT_PSG, 4, new SiMMLSimulatorVoiceSet(3));

        int i;
        SiMMLSimulatorVoiceSet toneVoiceSet;
        ...
        for (i = 0; i < 3; i++) this._channelVoiceSet.add(toneVoiceSet);
        ...
        this._channelVoiceSet.add(toneVoiceSet);
    }
}
